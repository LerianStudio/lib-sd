...
// Source: golang-plugin-boilerplate/internal/adapters/cache (interfaces: RedisRepository)
//
// Generated by this command:
//
//	mockgen --destination=consumer.redis.mock.go --package=cache . RedisRepository
//
